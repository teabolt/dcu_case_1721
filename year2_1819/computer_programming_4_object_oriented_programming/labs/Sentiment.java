...
public class Sentiment
{
   ...
   public static boolean subcontainsWord(String word, String reviewText) {
    ...
    public static void main(String[] args) throws FileNotFoundException{
        String review = "The increasingly diverse French director has created a film that one can honestly describe as looking , sounding and simply feeling like no other film in recent history .";
        String reviewFilename = "movieReviews.txt";
        System.out.println(Sentiment.sentiment(review, reviewFilename));
    }
}